Pod::Spec.new do |spec|
  spec.name         = "WGBAppleContainerView"
  spec.version      = "1.0.0"
  ...
  spec.homepage     = "https://github.com/wangguibin/WGBAppleContainerView"
  spec.license      = { :type => "MIT", :file => "LICENSE" }
  spec.author       = { "CoderWGB" => "CoderWGB@163.com" }
  
  spec.platform     = :ios, "9.0"
  spec.source       = { :git => "https://github.com/wangguibin/WGBAppleContainerView.git", :tag => "#{spec.version}" }
